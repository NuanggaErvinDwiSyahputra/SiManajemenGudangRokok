...
<div class="d-flex align-items-center">
    <button class="btn-add mb-4 border-0 px-3 py-2 text-black rounded-3 fw-medium d-flex align-items-center gap-2"
        onclick="location.href='{{route('barangmasuk-entry')}}'">
    ...
    <button class="btn-add mb-4 border-0 px-3 py-2 text-black rounded-3 fw-medium d-flex align-items-center gap-2 ms-2"
        onclick="location.href='{{route('pdfbarangmasuk')}}'">
...
<table class="table table-bordered text-center">
    ...
    @foreach($barangmasuk as $br)
        <tr>
            ...
            <td>{{$br->Jumlah}}</td>
            <td>
                <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#target{{ $br->Id_BarangMasuk }}">Edit</button>
                <button type="button" onclick="window.location='{{ route('barangmasuk-destroy', $br->Id_BarangMasuk) }}'" class="btn btn-dark">Delete</button>
            </td>
        </tr>
